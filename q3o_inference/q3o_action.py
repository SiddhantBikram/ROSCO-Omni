...
def main():
    parser = argparse.ArgumentParser(
        description='Classify child actions in videos using fine-tuned Qwen3 Omni LoRA.'
    )
    parser.add_argument(
        '--input', '-i',
        default='Data/',
    ...
    # --- Prompt Definition ---
    question = """Your task is to classify the primary communicative action of the child in this video. The child is non- or minimally-speaking and has profound autism and other complex neurodevelopmental disorders. Choose the most accurate option below.
