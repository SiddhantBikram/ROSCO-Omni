...
FEW_SHOT_EXAMPLES = {
    0: {
        "video_path": ".", 
        "reasoning": "The child taps on an AAC device with her finger to communicate 'I want to watch.'",
        "label": "Alternate and Augmented Communication"
    },
    1: {
        "video_path": ".", 
        "reasoning": "The child rejects the toy, and looks and crawls away from his mother.",
        "label": "Body"
    },
    2: {
        "video_path": ".", 
        "reasoning": "The child makes a pleased face in response to the toy and his mother.",
        "label": "Face"
    },
    3: {
        "video_path": ".", 
        "reasoning": "The child gives her mother an item from her hands, requesting her help.",
        "label": "Gesture"
    },
    4: {
        "video_path": ".", 
        "reasoning": "The child looks at the camera and is distracted from her mother.",
        "label": "Looking"
    },
    5: {
        "video_path": ".", 
        "reasoning": "The child vocalizes to express frustration and displeasure to her parents.",
        "label": "Vocalization"
    },
}
...
def main():
    ...
    csv_path = output_dir / 'g3flash_icl_action.csv'
    ...
    # --- Prompt Definition ---
    task_instruction = """Your task is to classify the primary communicative action of the child in this video. The child is non- or minimally-speaking and has profound autism and other complex neurodevelopmental disorders. Choose the most accurate option below.
